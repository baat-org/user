FROM adoptopenjdk/openjdk15:alpine as customJRECreateStage
MAINTAINER Sachin Goyal <sachin.goyal.se@gmail.com>
VOLUME /opt/custom/jre
...
COPY --from=customJRECreateStage /opt/custom/jre /opt/service/jre
ADD build/libs/$SERVICE.jar /opt/service/service.jar

ENTRYPOINT ["/opt/service/jre/bin/java","-jar","/opt/service/service.jar"]
